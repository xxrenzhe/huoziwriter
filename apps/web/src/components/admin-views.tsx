  ...
  return (
    <div className="space-y-8">
      <section className="border border-stone-800 bg-stone-950 p-6 md:p-8">
        <div className="text-xs uppercase tracking-[0.3em] text-cinnabar">Admin Console</div>
        <h1 className="mt-4 font-serifCn text-4xl text-stone-100 md:text-5xl text-balance">{title}</h1>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {metrics.map((metric) => (
          <article key={metric.label} className="border border-stone-800 bg-[#161616] p-5">
            ...
            <div className="mt-3 font-serifCn text-4xl text-stone-100 text-balance">{metric.value}</div>
      ...
      <section className="grid gap-4 xl:grid-cols-3">
        {panels.map((panel) => (
          <article key={panel.title} className="border border-stone-800 bg-[#171718] p-6">
            ...
            <h2 className="mt-4 font-serifCn text-2xl text-stone-100 text-balance">{panel.title}</h2>
