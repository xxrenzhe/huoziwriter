...
const successBannerClassName = cn(
  surfaceCardStyles({ tone: "success", padding: "sm" }),
  "text-sm text-emerald-700 shadow-none",
);
const warningBannerClassName = cn(
  surfaceCardStyles({ tone: "warning", padding: "sm" }),
  "text-sm text-warning shadow-none",
);
  ...
  return (
    ...
    >
      <section id="publishing-connections" className="space-y-4 scroll-mt-8">
        ...
        <div className={sectionCardClassName}>
          <div className={cn("mb-4", planSnapshot.canPublishToWechat ? successBannerClassName : warningBannerClassName)}>
