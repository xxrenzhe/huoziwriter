...
import { ReferralLinkCard } from "@/components/affiliate-client";
...
export default async function AffiliatePage() {
  ...
  const referralLink = `${appUrl}/r/${affiliate.referralCode}`;
      ...
      <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <aside className="border border-stone-300/40 bg-[#f4efe6] p-6">
          ...
          <div className="mt-4 space-y-3 text-sm text-stone-700">
            ...
            <div className="border border-stone-300 bg-white px-4 py-3 break-all">{referralLink}</div>
