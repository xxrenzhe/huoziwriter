...
import { OpsWritingEvalVersionsClient } from "@/components/ops-writing-eval-versions-client";
...
export default async function OpsWritingEvalVersionsPage({
  searchParams,
}: {
  ...
  const [versions, rolloutStats, promptVersions, scoringProfiles, layoutStrategies, applyCommandTemplates, assetRollouts, rolloutAuditLogs, promptRolloutAuditLogs] = await Promise.all([
        ...
        focusAsset={
          requestedAssetType && requestedAssetRef
            ? {
                ...
                clearHref: "/ops/writing-eval/versions",
              }
            : null
        }
