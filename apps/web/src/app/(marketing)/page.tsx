...
const landingFeatureItems = [
  { title: "全域采集", description: "支持手输素材、URL 穿透解析和截图上传，所有内容统一进入素材库。", meta: "Capture" },
  ...
  { title: "真实微信推送", description: "直接推送到微信公众号草稿箱，不做假占位。", meta: "Distribution" },
];
