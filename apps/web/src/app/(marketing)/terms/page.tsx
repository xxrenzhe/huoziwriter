const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    title: "2. 账号与权限",
    body:
      "v1 不开放用户自助注册。所有账号均由管理员手动创建并发放，首次登录后必须修改初始密码。你应妥善保管账号，不得向未授权第三方共享。",
  },
  {
    id: "subscription",
    title: "3. 订阅与退款",
    body:
      "当前套餐由后台手动配置，限制维度主要为生成次数、碎片容量、公众号连接额度和高级功能开关。外部支付渠道尚未接入，账单与退订由管理员或支持团队人工处理。",
  },
  {
    id: "content",
    title: "4. 内容归属与使用边界",
    body:
      "用户输入的碎片、文稿、排版基因和生成结果归用户所有。平台仅在完成采集、生成、审校、排版、导出和同步所必需的范围内处理这些内容，不会擅自公开出售或转作训练语料。",
  },
  {
    id: "wechat",
    title: "5. 微信公众号同步",
  ...
  },
  {
    ...
    title: "7. 条款变更",
    body:
      "当产品能力、套餐结构或数据处理边界发生实质性调整时，我们会更新本页内容。重大变更会优先通过站内公告、支持渠道或管理员通知方式同步给受影响用户。",
  },
] as const;
