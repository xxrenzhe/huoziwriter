const TERMS_SECTIONS = [
  ...
  },
  {
    ...
    title: "2. 账号与权限",
    body:
      "当前采用邀请开通制。你收到账号后，应在首次登录时修改初始密码，并妥善保管账号，不得向未授权第三方共享。",
  },
  {
    id: "subscription",
    title: "3. 订阅与退款",
    body:
      "当前套餐由支持团队协助开通和调整，限制维度主要为生成次数、素材容量、公众号连接额度和高级功能开关。账单、升级与退订请通过支持渠道处理。",
  },
  {
    id: "content",
    title: "4. 内容归属与使用边界",
  ...
  },
  {
    ...
    title: "7. 条款变更",
    body:
      "当产品能力、套餐结构或数据处理边界发生实质性调整时，我们会更新本页内容。重大变更会优先通过站内公告或支持渠道同步给受影响用户。",
  },
] as const;
